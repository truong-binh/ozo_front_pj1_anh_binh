...
export const WORKFLOW_STEPS: WorkflowStep[] = [
  ...
  { code: 'B5', stage: 'B', stageName: 'Nghiên cứu bào chế', name: 'Chốt mẫu nghiên cứu', dept: 'BGĐ', duration: 3, after: ['B3', 'B4'] },
  ...
  { code: 'D1', stage: 'D', stageName: 'Khả thi sản xuất', name: 'Đánh giá khả thi công bố', dept: 'PC-DV', duration: 5, after: ['B8'] },
  { code: 'D2', stage: 'D', stageName: 'Khả thi sản xuất', name: 'Đánh giá khả thi sản xuất', dept: 'NCC', duration: 5, after: ['B7'] },
  { code: 'D3', stage: 'D', stageName: 'Khả thi sản xuất', name: 'Pha mẫu và sửa mẫu', dept: 'NCC', duration: 20, after: ['D2'] },
  { code: 'D4', stage: 'D', stageName: 'Khả thi sản xuất', name: 'Phê duyệt NCC gia công', dept: 'PP', duration: 7, after: ['D3'] },
  { code: 'D5', stage: 'D', stageName: 'Khả thi sản xuất', name: 'Theo dõi độ ổn định chính thức tại nhà máy', dept: 'NCC', duration: 90, after: ['D4'] },
  { code: 'E1', stage: 'E', stageName: 'Công bố', name: 'Soạn hồ sơ công bố', dept: 'PC-DV', duration: 7, after: ['D4'] },
